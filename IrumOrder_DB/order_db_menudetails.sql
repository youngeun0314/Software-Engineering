...
CREATE TABLE `menudetails` (
  `menuDetail_id` int NOT NULL AUTO_INCREMENT,
  `useCup` varchar(50) NOT NULL,
  `addShot` tinyint(1) DEFAULT '0',
  `addVanila` tinyint(1) DEFAULT '0',
  `addHazelnut` tinyint(1) DEFAULT '0',
