...
CREATE TABLE `menudetails` (
  `menu_detail_id` int NOT NULL AUTO_INCREMENT,
  `use_cup` varchar(255) NOT NULL,
  `add_shot` tinyint(1) DEFAULT '0',
  `add_vanilla` tinyint(1) DEFAULT '0',
  `add_hazelnut` tinyint(1) DEFAULT '0',
...
INSERT INTO `menudetails` VALUES (1,'TakeOut',1,0,1,1),(2,'TakeOut',1,0,1,1);
